    ...
    <div>
        <table class="table" style="padding: 2px;">
            <tr style="font-size: 11px;">
                <td><label for="">{{ __('transcript.name') }} : </label><span>{{ $credential->name }}</span></td>
                <td><label for="">{{ __('transcript.matricule') }} : </label><span>{{ $credential->matricule }}</span></td>
                <td><label for="">{{ __('transcript.year') }} : </label><span>{{ $academic_year }}</span></td>
            </tr>
            <tr style="font-size: 11px;">
                <td><label for="">{{ __('transcript.dob') }} : </label><span>{{ date('d/m/Y', strtotime($credential->dob)) }}</span></td>
                <td><label for="">{{ __('transcript.pob') }} : </label><span>{{ $credential->pob }}</span></td>
                <td><label for="">Cycle: </label><span>{{ $credential->cycle->name }}</span></td>
            </tr>
            <tr style="font-size: 11px;">
                <td colspan="2"><label for="">{{ __('transcript.specialty') }} : </label><span>{{ $credential->specialty->name }}</span></td>
                <td><label for="">{{ __('transcript.level') }} : </label><span>{{ $level }}</span></td>
            </tr>
        </table>
    </div>
        ...
        <table border="0px" class="table">
            <thead style="background-color: lightgray;text-align:center; font-size:10px;">
                <tr class="table-danger">
                    <th style="padding: 2px">Unit code</th>
                    <th>Course code</th>
                    <th>Course title</th>
            ...
            <tbody style="background-color: white; text-align: center; font-size: 10px;">
                ...
                @if($tdr == 1 && $semester_mod == $semester->name)
